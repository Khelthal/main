...
def step_impl(context, usuario, contra):
    ...
    context.usuario_institucion = crear_usuario(
        usuario, "prueba-institucion@prueba.com", contra, context.tipo_institucion, aprobado=True)
    context.usuario_investigador = crear_usuario(
        "Investigador", "prueba-investigador@prueba.com", "prueba", context.tipo_investigador, aprobado=True)
...
def step_impl(context, usuario, contra):
    context.tipo_investigador = crear_tipo_usuario("Investigador")
    context.usuario_investigador = crear_usuario(usuario=usuario, correo="prueba@prueba.com",
