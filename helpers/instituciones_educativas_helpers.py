...
def crear_institucion_educativa(encargado, nombre_institucion, especialidades, miembros, codigo_postal, municipio, colonia, calle, numero_exterior, acerca_de, latitud=0, longitud=0):
